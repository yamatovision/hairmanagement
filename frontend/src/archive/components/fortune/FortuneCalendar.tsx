...
import { useFortune } from '../../contexts/FortuneContext';
import { ELEMENT_PROPERTIES } from '../../utils/sharedTypes';
import { useFortune as useFortuneHook } from '../../hooks/useFortune';
      ...
      <Box sx={{ mt: 3, mb: 4 }}>
        ...
        >
          ...
          <Typography variant="body1" paragraph>
            {errorMessage || 'データの初期化中です。このメッセージが続く場合はシステム管理者に連絡してください。'}
          </Typography>
          <Chip 
            label="再読み込み" 
            color="primary" 
    ...
    <Box sx={{ mt: 3, mb: 4 }}>
      ...
      <Grid container spacing={1}>
        {getWeekDates().map((date, index) => {
          ...
          // sajuDataから要素を取得するように修正
          const element = fortune?.sajuData?.mainElement || '木';
          const elementColor = getElementColor(element);
          // overallScoreを使用するように修正
          const luckScore = fortune?.overallScore || 50;
